 ...
 * @author Ramindu
 */
public class AccounterHomeScreen extends javax.swing.JFrame {

    /**
     * Creates new form AccounterHomeScreen
     */
...
// Add placeholder text:
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Ramindu Accounter");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        AccounterChatScreen chat = new AccounterChatScreen(this, true); // 'this' = parent frame
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccounterHomeScreen().setVisible(true);
            }
        });
    }
