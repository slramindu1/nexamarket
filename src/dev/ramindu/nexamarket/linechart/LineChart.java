...
import dev.ramindu.nexamarket.linechart.blankchart.BlankPlotChart;
import dev.ramindu.nexamarket.linechart.blankchart.BlankPlotChatRender;
import dev.ramindu.nexamarket.linechart.blankchart.SeriesSize;
...
public class LineChart extends javax.swing.JPanel {
    ...
    private List<ModelChart1> model = new ArrayList<>();
    ...
    public void addData(ModelChart1 data) {
        model.add(data);
    ...
    private void initComponents() {
        ...
        blankPlotChart = new dev.ramindu.nexamarket.linechart.blankchart.BlankPlotChart();
    ...
    private dev.ramindu.nexamarket.linechart.blankchart.BlankPlotChart blankPlotChart;
