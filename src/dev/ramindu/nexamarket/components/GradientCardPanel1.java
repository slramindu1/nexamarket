...
public class GradientCardPanel1 extends JPanel {

    public GradientCardPanel1() {
        setOpaque(false);
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(
                0, 0, new Color(58, 123, 213), // Light Blue
                getWidth(), getHeight(), new Color(142, 45, 226)); // Purple
